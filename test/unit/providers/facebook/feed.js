...
var postsResult 			= require('../../../utils/json/facebook/feedient_response/posts.json');
...
describe('Facebook Feed Test', function() {
	describe('calling getFeed', function () {
		it('should process  the feed correctly', function (done) {
...
function scan(obj, isExpected, callback) {
	var k;
	if (obj instanceof Object) {
		for (k in obj) {
			if (obj.hasOwnProperty(k)){
				//has childs
				scan(obj[k], isExpected, callback);
			}
		}
		return callback();
	} else {
